...
For example, a user may ask for ``surface chlorophyll in the California Current during summer months'' or request candidate datasets for ``mixed-layer depth''.
...
%\input{supp/vignettes/vignette_01_discovery}

\input{supp/vignettes/vignette_02_climatology}

\input{supp/vignettes/vignette_03_colocalize}
