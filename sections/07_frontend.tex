...
A public web deployment of the chat interface is available at \url{https://simonscmap.ai}.

\paragraph{Artifact presentation.}
Artifacts are treated as first-class outputs: rather than being buried in a transcript or returned only as text, generated figures and data files are surfaced alongside the assistant's response and remain individually accessible after the session.
