...
The literature reference bank---the per-dataset corpus of full-text scientific documents indexed alongside catalog metadata (Section~\ref{sec:kb})---is maintained as a separately versioned, refreshable asset, so that the precise corpus available to the agent at any point in time can be recorded and, if needed, reconstructed.
