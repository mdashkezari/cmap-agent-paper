...
We therefore mention CMAP's curation only insofar as it strengthens grounding, provenance, and reproducibility claims for the agentic layer.
...
Several research and development directions are motivated by both the agent literature \citep{Wang2023LLMAgentSurvey,Luo2025LLMAgentSurvey} and current needs in Earth-system data analysis \citep{Zhao2024AIforGeoscience}:
