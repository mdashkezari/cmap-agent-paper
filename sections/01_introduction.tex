...
\begin{enumerate}[leftmargin=*]
  ...
  \item A capability suite that operationalizes common CMAP workflows (dataset discovery, spatiotemporal subsetting, visualization, climatology, and colocalization) with artifact-centric outputs.
