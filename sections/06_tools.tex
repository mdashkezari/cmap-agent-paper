...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Visualization:} generate quick-look figures that summarize retrieved subsets.
...
\bottomrule
\end{tabular}
\caption{Capability-oriented summary of \cmapagent.}
...
Algorithm~\ref{alg:execute_plan} summarizes this control flow in compact pseudocode listing.
